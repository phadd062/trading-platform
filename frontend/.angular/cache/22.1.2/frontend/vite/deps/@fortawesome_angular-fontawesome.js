import { T as DOCUMENT$1, c as computed, oa as ɵɵdefineInjectable, sa as ɵɵdefineInjector, x as CSP_NONCE, xr as inject, yn as effect } from "./_resource-chunk-BKjjpPrA.js";
import { Ba as ɵɵdefineDirective, Gt as ChangeDetectionStrategy, Ho as ɵɵprojection, Jt as Component, Ki as ɵɵInheritDefinitionFeature, Nn as NgModule, Oi as setClassMetadata, Qa as ɵɵdomProperty, Sn as Input, Uo as ɵɵprojectionDef, Va as ɵɵdefineNgModule, X as input, fo as ɵɵgetInheritedFactory, ia as ɵɵclassMap, nt as model, ps as ɵɵsanitizeHtml, ra as ɵɵattribute, un as Directive, xn as Injectable, za as ɵɵdefineComponent, zn as Output } from "./core-tK2ALGvq.js";
import { r as DomSanitizer } from "./platform-browser-DpdD35qi.js";
...
//#endregion
//#region node_modules/@fortawesome/angular-fontawesome/fesm2022/angular-fontawesome.mjs
var _c0 = ["*"];
var FaConfig = class FaConfig {
	/**
...
var FaIconLibrary = class FaIconLibrary {
	definitions = {};
	addIcons(...icons) {
		for (const icon of icons) {
			if (!(icon.prefix in this.definitions)) this.definitions[icon.prefix] = {};
			this.definitions[icon.prefix][icon.iconName] = icon;
			for (const alias of icon.icon[2]) if (typeof alias === "string") this.definitions[icon.prefix][alias] = icon;
		}
	}
	addIconPacks(...packs) {
	...
	getIconDefinition(prefix, name) {
		if (prefix in this.definitions && name in this.definitions[prefix]) return this.definitions[prefix][name];
		return null;
	}
...
function ensureCss(document, config, nonce) {
	if (!config.autoAddCss) return;
	if (cssInserted.has(document)) return;
...
var faNormalizeIconSpec = (iconSpec, defaultPrefix) => {
	if (isIconLookup(iconSpec)) return iconSpec;
	if (Array.isArray(iconSpec) && iconSpec.length === 2) return {
		prefix: iconSpec[0],
		iconName: iconSpec[1]
	};
	return {
...
var FaStackItemSizeDirective = class FaStackItemSizeDirective {
	/**
	* Specify whether icon inside {@link FaStackComponent} should be rendered in
	* regular size (1x) or as a larger icon (2x).
	*/
	stackItemSize = input("1x", ...ngDevMode ? [{ debugName: "stackItemSize" }] : 	/* istanbul ignore next */ []);
	/**
	* @internal
	*/
	size = input(...ngDevMode ? [void 0, { debugName: "size" }] : 	/* istanbul ignore next */ []);
	_effect = effect(() => {
		if (this.size()) throw new Error("fa-icon is not allowed to customize size when used inside fa-stack. Set size on the enclosing fa-stack instead: <fa-stack size=\"4x\">...</fa-stack>.");
...
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FaStackItemSizeDirective, [{
		type: Directive,
		args: [{ selector: "fa-icon[stackItemSize],fa-duotone-icon[stackItemSize]" }]
	}], null, {
		stackItemSize: [{
			type: Input,
			args: [{
...
var FaStackComponent = class FaStackComponent {
	/**
	...
	*/
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		hostBindings: function FaStackComponent_HostBindings(rf, ctx) {
			if (rf & 2) ɵɵclassMap(ctx.classes());
		},
		inputs: { size: [1, "size"] },
...
var FaIconComponent = class FaIconComponent {
	icon = model(...ngDevMode ? [void 0, { debugName: "icon" }] : 	/* istanbul ignore next */ []);
	/**
	...
	* screen readers.
	*/
	title = model(...ngDevMode ? [void 0, { debugName: "title" }] : 	/* istanbul ignore next */ []);
	/**
	* Icon animation.
	*
	...
	*/
	animation = model(...ngDevMode ? [void 0, { debugName: "animation" }] : 	/* istanbul ignore next */ []);
	mask = model(...ngDevMode ? [void 0, { debugName: "mask" }] : 	/* istanbul ignore next */ []);
	flip = model(...ngDevMode ? [void 0, { debugName: "flip" }] : 	/* istanbul ignore next */ []);
	size = model(...ngDevMode ? [void 0, { debugName: "size" }] : 	/* istanbul ignore next */ []);
	pull = model(...ngDevMode ? [void 0, { debugName: "pull" }] : 	/* istanbul ignore next */ []);
	border = model(...ngDevMode ? [void 0, { debugName: "border" }] : 	/* istanbul ignore next */ []);
	inverse = model(...ngDevMode ? [void 0, { debugName: "inverse" }] : 	/* istanbul ignore next */ []);
	symbol = model(...ngDevMode ? [void 0, { debugName: "symbol" }] : 	/* istanbul ignore next */ []);
	rotate = model(...ngDevMode ? [void 0, { debugName: "rotate" }] : 	/* istanbul ignore next */ []);
	fixedWidth = model(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 	/* istanbul ignore next */ []);
	transform = model(...ngDevMode ? [void 0, { debugName: "transform" }] : 	/* istanbul ignore next */ []);
	/**
	* Specify the `role` attribute for the rendered <svg> element.
	*
	* @default 'img'
	*/
	a11yRole = model(...ngDevMode ? [void 0, { debugName: "a11yRole" }] : 	/* istanbul ignore next */ []);
	...
	constructor() {
		if (this.stack != null && this.stackItem == null) console.error("FontAwesome: fa-icon and fa-duotone-icon elements must specify stackItemSize attribute when wrapped into fa-stack. Example: <fa-icon stackItemSize=\"2x\" />.");
	}
	...
	buildParams() {
		...
		if (a11yRole != null) attributes["role"] = a11yRole;
		const styles = {};
		if (classOpts.rotate != null && !isKnownRotateValue(classOpts.rotate)) styles["--fa-rotate-angle"] = `${classOpts.rotate}`;
		return {
			title: this.title(),
...
var FaDuotoneIconComponent = class FaDuotoneIconComponent extends FaIconComponent {
	/**
	...
	* @default false
	*/
	swapOpacity = input(...ngDevMode ? [void 0, { debugName: "swapOpacity" }] : 	/* istanbul ignore next */ []);
	/**
	...
	* @default 1.0
	*/
	primaryOpacity = input(...ngDevMode ? [void 0, { debugName: "primaryOpacity" }] : 	/* istanbul ignore next */ []);
	/**
	...
	* @default 0.4
	*/
	secondaryOpacity = input(...ngDevMode ? [void 0, { debugName: "secondaryOpacity" }] : 	/* istanbul ignore next */ []);
	/**
	...
	*/
	primaryColor = input(...ngDevMode ? [void 0, { debugName: "primaryColor" }] : 	/* istanbul ignore next */ []);
	/**
	...
	* @default CSS inherited color
	*/
	secondaryColor = input(...ngDevMode ? [void 0, { debugName: "secondaryColor" }] : 	/* istanbul ignore next */ []);
	findIconDefinition(i) {
		const definition = super.findIconDefinition(i);
		if (definition != null && !Array.isArray(definition.icon[4])) throw new Error(`The specified icon does not appear to be a Duotone icon. Check that you specified the correct style: <fa-duotone-icon [icon]="['fad', '${definition.iconName}']" /> or use: <fa-icon icon="${definition.iconName}" /> instead.`);
		return definition;
	}
	buildParams() {
		const params = super.buildParams();
		const swapOpacity = this.swapOpacity();
		if (swapOpacity === true || swapOpacity === "true") if (Array.isArray(params.classes)) params.classes.push("fa-swap-opacity");
		else if (typeof params.classes === "string") params.classes = [params.classes, "fa-swap-opacity"];
		else params.classes = ["fa-swap-opacity"];
		if (params.styles == null) params.styles = {};
		const primaryOpacity = this.primaryOpacity();
		if (primaryOpacity != null) params.styles["--fa-primary-opacity"] = primaryOpacity.toString();
		const secondaryOpacity = this.secondaryOpacity();
		if (secondaryOpacity != null) params.styles["--fa-secondary-opacity"] = secondaryOpacity.toString();
		const primaryColor = this.primaryColor();
		if (primaryColor != null) params.styles["--fa-primary-color"] = primaryColor;
		const secondaryColor = this.secondaryColor();
		if (secondaryColor != null) params.styles["--fa-secondary-color"] = secondaryColor;
		return params;
	}
...
var faWarnIfParentNotExist = (parent, parentName, childName) => {
	if (!parent) throw new Error(`${childName} should be used as child of ${parentName} only.`);
};
/**
* Fontawesome layers.
*/
var FaLayersComponent = class FaLayersComponent {
	size = input(...ngDevMode ? [void 0, { debugName: "size" }] : 	/* istanbul ignore next */ []);
	fixedWidth = input(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 	/* istanbul ignore next */ []);
	faFw = computed(() => {
		const fixedWidth = this.fixedWidth();
...
var FaLayersCounterComponent = class FaLayersCounterComponent {
	...
	position = input(...ngDevMode ? [void 0, { debugName: "position" }] : 	/* istanbul ignore next */ []);
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		hostBindings: function FaLayersCounterComponent_HostBindings(rf, ctx) {
			if (rf & 2) ɵɵdomProperty("innerHTML", ctx.renderedHTML(), ɵɵsanitizeHtml);
		},
		inputs: {
			content: [1, "content"],
			title: [1, "title"],
...
var FaLayersTextComponent = class FaLayersTextComponent {
	content = input.required(...ngDevMode ? [{ debugName: "content" }] : 	/* istanbul ignore next */ []);
	title = input(...ngDevMode ? [void 0, { debugName: "title" }] : 	/* istanbul ignore next */ []);
	flip = input(...ngDevMode ? [void 0, { debugName: "flip" }] : 	/* istanbul ignore next */ []);
	size = input(...ngDevMode ? [void 0, { debugName: "size" }] : 	/* istanbul ignore next */ []);
	pull = input(...ngDevMode ? [void 0, { debugName: "pull" }] : 	/* istanbul ignore next */ []);
	border = input(...ngDevMode ? [void 0, { debugName: "border" }] : 	/* istanbul ignore next */ []);
	inverse = input(...ngDevMode ? [void 0, { debugName: "inverse" }] : 	/* istanbul ignore next */ []);
	rotate = input(...ngDevMode ? [void 0, { debugName: "rotate" }] : 	/* istanbul ignore next */ []);
	fixedWidth = input(...ngDevMode ? [void 0, { debugName: "fixedWidth" }] : 	/* istanbul ignore next */ []);
	transform = input(...ngDevMode ? [void 0, { debugName: "transform" }] : 	/* istanbul ignore next */ []);
	renderedHTML = computed(() => {
		const params = this.buildParams();
		return this.updateContent(params);
	}, ...ngDevMode ? [{ debugName: "renderedHTML" }] : 	/* istanbul ignore next */ []);
...
var FontAwesomeModule = class FontAwesomeModule {
